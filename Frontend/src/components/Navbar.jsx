...
const Navbar = () => {
  ...
  return (
    ...
    location !== "/signup" && (
      ...
      sm:flex-col sm:h-screen sm:static sm:w-fit sm:px-2 lg:w-1/5 lg:px-3 sm:border-t-0 sm:border-r-[1px] lg:justify-between lg:py-10
      "
      >
        <img
        ...
        <div className=" flex justify-around w-full sm:flex-col sm:gap-5">
          <Link
            to={"/home"}
            className=" flex gap-3 items-center p-3 rounded-md lg:hover:bg-[#1A1A1A] lg:transition-all lg:duration-75"
            id="f-op-1"
          >
            <img
          ...
          <div className="" id="f-op-3">
            <label
              htmlFor="postImage"
              className=" cursor-pointer flex gap-3 items-center p-3 rounded-md lg:hover:bg-[#1A1A1A] lg:transition-all lg:duration-75"
            >
        ...
        <Link
          to={"/profile/settings"}
          className=" hidden sm:block lg:flex gap-3 items-center p-3 rounded-md lg:hover:bg-[#1A1A1A] lg:transition-all lg:duration-75"
        >
